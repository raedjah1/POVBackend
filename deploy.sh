...
deploy_environment "povreality-backend-test" "Python 3.9 running on 64bit Amazon Linux 2023"

# Deploy Streaming Environment
echo "Deploying Streaming Environment..."
cd streaming-env
deploy_environment "povreality-streaming-test" "Docker running on 64bit Amazon Linux 2"
cd ../
